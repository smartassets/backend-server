...
public class JdbcSinkTask extends SinkTask {
    ...
    void initWriter() {
        if (config.dialectName != null && !config.dialectName.trim()
                                                             .isEmpty()) {
        ...
        log.info("Initializing writer using SQL dialect: {}", dialect.getClass()
                                                                     .getSimpleName());
    ...
    public void put(Collection<SinkRecord> records) {
        ...
        final SinkRecord first = records.iterator()
                                        .next();
        final int recordsCount = records.size();
        log.debug("Received {} records. First record kafka coordinates:({}-{}-{}). Writing them to the " + "database...", recordsCount,
